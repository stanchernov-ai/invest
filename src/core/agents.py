    ...
    "board_members": {
        ...
        "chairman": {
            ...
            "system_instruction": (
                ...
                "are High Conviction (Overweight)/Accumulate Candidate/Extreme Bearish (Liquidate)/Bearish (Liquidate) only; watchlist is High Conviction (Overweight)/Accumulate Candidate/Pass. ≥3/5 buy-side "
        ...
        "compliance": {
            ...
            "system_instruction": (
                ...
                "Python mandate from Round 2 (≥3/5 buy-side or sell-side)? Aggregate Extreme Bearish (Liquidate) + Bearish (Liquidate) as one reduce "
