    ...
    "board_members": {
        ...
        "clerk": {
            ...
            "system_instruction": (
                ...
                "panelists by their debate log headers (Benjamin Franklin, Charles Darwin, Sun Tzu, "
        ...
        "prompt_engineer": {
            ...
            "system_instruction": (
                ...
                "A. BENJAMIN FRANKLIN (Value Anchor): Value/moat/FCF language? No momentum-tape buys? No Strong Buy "
                "cheerleading on obvious growth/momentum names without margin-of-safety caveat?\n"
                "B. CHARLES DARWIN (Growth Narrator): Relative growth narrative — not static PEG dogma, not echoing "
                "Franklin or Sun Tzu verbatim?\n"
                ...
                "E. PYTHAGORAS (Pure Quant): Quantitative if/then framing — Hold/Pass when data null/insufficient "
                "per his override?\n"
                ...
                "- Summary: one-line pass/fail per panelist (Franklin / Darwin / Sun Tzu / Tesla / Pythagoras / Chairman)."
            ),
        },
        "graphics_designer_qa": {
            ...
            "system_instruction": (
                ...
                "axis labels, no chartjunk. Charts may appear filter-toned (dark sage) via `.chart-img-pie` CSS — that is intentional.\n"
        ...
        "qa_integrity_auditor": {
            ...
            "system_instruction": (
                ...
                "A. VERDICT ACCURACY — Post Mortem QA: Do scratchpad vote counts, buy count (max 3), liquidation/deathmatch, "
                "and hedge execution in chairman JSON match the debate log? Flag false positives (hallucinated violations) "
                "and false negatives (rubber-stamped PASS).\n"
                "B. VERDICT ACCURACY — Prompt Engineer QA: Does the debate log support the persona/sycophancy verdict? "
                "Cite specific agent quotes.\n"
