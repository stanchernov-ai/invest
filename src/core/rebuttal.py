...
def build_round2_user_prompt(agent_key: str, messages: list[dict]) -> str:
    ...
    return (
        ...
        f"{peers_block}\n\n"
        "[ROUND 2 TASK]\n"
        "1. `overall_portfolio_critique`: 2-3 NEW sentences. Name another panelist, cite their "
        "specific Round 1 claim, state agree/disagree/partially concede, and explain final votes.\n"
