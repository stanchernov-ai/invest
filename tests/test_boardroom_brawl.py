...
def _valid_brawl() -> str:
    return (
        "Warren Buffett opened Round 1 by dismissing momentum names as speculation without moats, "
        "while Jesse Livermore countered that the tape already priced in those fears. "
        "Peter Lynch bridged the gap by arguing growth at a reasonable price still mattered.\n\n"
        "Round 2 turned personal when Jensen Huang attacked Simons for treating NVDA as a spreadsheet row, "
        "and Jim Simons fired back that Huang ignored correlation risk across the AI cluster. "
        "Buffett and Lynch traded barbs over whether concentration in mega-cap tech was courage or complacency.\n\n"
        ...
        messages = [
            ...
            },
            {
                "content": (
                    ...
                    "* **Rebuttal Summary**: Buffett ignores the tape.\n"
    ...
    def test_fallback_produces_three_paragraphs(self):
        messages = [
            ...
            },
            {
                "content": (
                    "**[ROUND 2 REBUTTAL] Jesse Livermore**:\n"
                    "* **Rebuttal Summary**: The tape disagrees with Buffett.\n"
                ),
            },
        ]
