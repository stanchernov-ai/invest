...
class PrepareHttpGuardTests(unittest.TestCase):
    ...
    def test_rejects_when_run_in_flight(self, mock_in_flight, _mock_run_id, _mock_phase):
        import function_app
    ...
    def test_allows_when_no_run_in_flight(self, _mock_in_flight, _mock_run_id, mock_phase, _mock_prepare):
        import function_app
